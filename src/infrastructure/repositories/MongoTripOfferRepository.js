...
class MongoTripOfferRepository extends TripOfferRepository {
  ...
  async searchPublishedTrips(filters = {}) {
    ...
    // Execute query with populated driver and vehicle info
    let docs = await TripOfferModel.find(query)
      .populate('driverId', 'firstName lastName profilePhoto')
    ...
    return {
      ...
      populatedDocs: docs, // Return populated documents for DTO creation
      total,
      page,
      pageSize: limit,
