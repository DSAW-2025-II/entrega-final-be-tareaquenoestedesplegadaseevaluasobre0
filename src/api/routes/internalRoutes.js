...
/**
 * GET /internal/database/collections
 * Admin-only: View database collections summary (development/debugging)
    ...
    try {
      ...
      for (const collectionName of collectionNames) {
        ...
        summary[collectionName] = {
          count,
          sample: count > 0 ? await collection.find({}).limit(1).toArray() : []
        };
      }
      ...
      console.error('[InternalRoutes] Database summary error:', error);
      res.status(500).json({
        code: 'server_error',
